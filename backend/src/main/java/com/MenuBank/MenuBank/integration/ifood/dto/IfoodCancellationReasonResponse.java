 ...
 *
 * <p>Homologation requires the merchant to pick from iFood's own list — MenuBank never
 ...
 *
 * <p>The same record is used for the iFood payload and for the MenuBank REST response:
